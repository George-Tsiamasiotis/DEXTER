...
py_get_enum_string!(PyUnityQfactor, psi_state);
py_get_enum_string!(PyUnityQfactor, psip_state);
...
py_get_enum_string!(PyParabolicQfactor, psi_state);
py_get_enum_string!(PyParabolicQfactor, psip_state);
