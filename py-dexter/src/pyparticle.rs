//! `dexter_simulate::Particle` newtype, constructors and method exports.

use dexter::dexter_simulate::{
    InitialConditions, InitialFlux, IntersectParams, Intersection, Particle, SteppingMethod,
};
...
py_export_getter!(PyInitialConditions, t0, f64);
py_export_getter!(PyInitialConditions, theta0, f64);
py_export_getter!(PyInitialConditions, zeta0, f64);
py_export_getter!(PyInitialConditions, mu0, f64);
py_export_getter!(PyInitialConditions, rho0, Option<f64>);
py_export_getter!(PyInitialConditions, pzeta0, Option<f64>);
...
py_get_enum_string!(PyParticle, energy_pzeta_position);
...
mod py_particle_generics_impl {
    ...
    use crate::{
        generic_particle_close_impl, generic_particle_integrate_impl,
        generic_particle_intersect_impl,
    };
