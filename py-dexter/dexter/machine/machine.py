...
class Machine:
    ...
    @property
    def psip_last(self) -> MagneticFlux:
        return self.qfactor.psip_last

    @property
    def baxis(self) -> float:
        if self.geometry is not None:
            return self.geometry.baxis
        else:
